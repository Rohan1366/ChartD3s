...
const Bargraph = () => {
    ...
    useEffect(() => {
      ...
      const x = d3.scaleBand().range([0, width]).padding(0.57);
      ...
      svg
        ...
        .append('rect')
        .attr('class', 'bar')
        .attr('x', (d) => x(d.formattedDate) + x.bandwidth() / 7) // Centering the bars
        .attr('y', (d) => y(d.value))
      ...
      svg
        ...
        .attr('y', 10) // Adjusted vertical position
    ...
    return (
      <div style={{ border:'2px solid white', background: 'white',marginLeft:'10px' , marginBottom:'10px', height:'42vh', borderRadius:'3%',paddingTop:'15px'}}>
